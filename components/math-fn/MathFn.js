...
MathFn.getCircleCoordinates = function(radius){
    ...
    if (EraserTool.prototype._getCircleCoordinates[radius]){
        return EraserTool.prototype._getCircleCoordinates[radius]
    }
    ...
    EraserTool.prototype._getCircleCoordinates[radius] = coordinates;
